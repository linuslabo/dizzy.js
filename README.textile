...
There is a version of the "online editor":http://linuslabo.github.io/dizzy.js/editor/ for presentation files available, although you could also host your own with the newer code provided here (no serverside code needed). (:
